...
if (message.content.startsWith(`${prefix}suicide`)) {
   ...
   if (message.content.startsWith(`${prefix}roles`)) {
        ...
        let rolesembed = new Discord.RichEmbed()
            .setTitle('**➡️ РОЛИ**')
            .addField('#Управляющие сервером:', '***<@428228557039337484> — Создатель сервера.\n\n<@538736285620240394> — Администраторы сервера.***' )
            .addField('#Можно выпросить у администрации:', '<@429279432113520644>\n<@429279202005745673>\n<@429279274638508033>\n<@492394551642685440>\n<@492394529635303434>\n<@609975208320696370>')
            .addField('#Зарабатывается честным трудом:', '<@477269062536396811> — За рассказ **"интересных"** историй.\n\n<@481165390769029140> — Для **музыкантов** или **певцов**.\n\n<@551168722321145857> — Для тех, у кого **не сломался голос**.<@474366462258053120> — Нужен **25 LVL** в чате.\n\n<@474366397309255682> — Нужен **15 LVL** в чате.\n\n<@474366520240242718> — **Нужен 5 LVL** в чате.\n\n***Узнать свой уровень*** — `!rank`⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀***Таблица лидеров*** — `!levels`\n\n<@492761591624892416> ***— Выдаётся пользователям которые нарушают правила.***')
            .addField('#Роли за серверную валюту:', '***<@601820110826766354>\n<@601820129457864714>\n<@601820124441214996>\n<@601820114932858899>\n<@601820121627099177>\n<@601820127842926603>\n<@601820105659252767>\n<@601820118288302080>\n<@601763535839559710>\n<@601763619587227668>\n<@464524136841216000>\n<@460946848732020738>\n<@494162041553027083>\n<@429279393295237122>\n<@460966568944336906>\n<@429279414359031809>\n<@460920161835286538>\n<@457299732172374026>\n<@429279355957411840>\n<@460918248846917664>***')
            .addField('#Гендерные:', '<@492395268755685402> — Парням.\n\n<@492395239852736552> — Девушкам.\n\n<@492395279958671380> — Выдаётся автоматически как только вы зашли на сервер.')  
            .setTimestamp()
            .setColor('397DEE')
            .setThumbnail('https://cdn.discordapp.com/emojis/598200842679615499.png?v=1')
