...
if (message.content.startsWith(`${prefix}info`)){
    ...
    .setColor("397DEE")
    .setURL('https://media.discordapp.net/attachments/428223641961103360/695322659700998194/FunDZNs_4.png?width=474&height=474')
    .addField("__**«►СВЕРХКОНФА»**__ является русскоязычным и многофункциональным сервером Discord.")
    .addField("Сервер создан с целью создать уютное место с ламповым общением, в котором можно найти друзей, тиммейтов для различных игр или просто хороших собеседников.Мы всеми силами стараемся не превратить это место в помойку.")
    .addField("Будем очень рады, если пригласите своих друзей на наш сервер.Перед тем как начать общение с участниками нашего сервера, обязательно прочитай правила в канале — <#609967834516291584>")
    .addField("**Приятного времяпровождения!** <:428299875751297026:>\n _**Беседа в VK -**_ \n **https://vk.me/join/AJQ1d0glkwYj6XP2IXswN6tz** \n _**Беседа в Telegram**_ -\n **https://t.me/CBEPXKOHFA**")
